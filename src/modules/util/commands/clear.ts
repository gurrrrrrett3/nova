...
const Command = new SlashCommandBuilder()
    ...
    .setNameLocalizations(LanguageLoader.getKeyLocalizations("util:commands.clear.name"))
    .setDescriptionLocalizations(LanguageLoader.getKeyLocalizations("util:commands.clear.description"))
    ...
    .addIntegerOption((option) =>
        option
            ...
            .setNameLocalizations(LanguageLoader.getKeyLocalizations("util:commands.clear.options.amount.name"))
            .setDescriptionLocalizations(LanguageLoader.getKeyLocalizations("util:commands.clear.options.amount.description"))
            .setRequired(true)
            .setMinValue(1)
            .setMaxValue(100)
    )
    .addUserOption((option) =>
        option
            ...
            .setNameLocalizations(LanguageLoader.getKeyLocalizations("util:commands.clear.options.user.name"))
            .setDescriptionLocalizations(LanguageLoader.getKeyLocalizations("util:commands.clear.options.user.description"))
            .setRequired(false)
    )
