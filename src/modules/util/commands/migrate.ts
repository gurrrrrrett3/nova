...
const Command = new SlashCommandBuilder()
    ...
    .setNameLocalizations(LanguageLoader.getKeyLocalications("util:commands.migrate.name"))
    .setDescriptionLocalizations(LanguageLoader.getKeyLocalications("util:commands.migrate.description"))
    ...
    .addChannelOption((option) =>
        option
            ...
            .setNameLocalizations(LanguageLoader.getKeyLocalications("util:commands.migrate.options.from.name"))
            .setDescriptionLocalizations(LanguageLoader.getKeyLocalications("util:commands.migrate.options.from.description"))
    ...
    .addChannelOption((option) =>
        option
            ...
            .setNameLocalizations(LanguageLoader.getKeyLocalications("util:commands.migrate.options.to.name"))
            .setDescriptionLocalizations(LanguageLoader.getKeyLocalications("util:commands.migrate.options.to.description"))
            .addChannelTypes(ChannelType.GuildVoice, ChannelType.GuildStageVoice)
            .setRequired(true)
    )
    .addStringOption((option) =>
        option
            ...
            .setNameLocalizations(LanguageLoader.getKeyLocalications("util:commands.migrate.options.reason.name"))
            .setDescriptionLocalizations(LanguageLoader.getKeyLocalications("util:commands.migrate.options.reason.description"))
    )
    .addBooleanOption((option) =>
        option
            .setName("permissions")
            .setDescription(t("util:commands.migrate.options.permissions.description"))
            .setNameLocalizations(LanguageLoader.getKeyLocalications("util:commands.migrate.options.permissions.name"))
            .setDescriptionLocalizations(LanguageLoader.getKeyLocalications("util:commands.migrate.options.permissions.description"))
    )
    .addBooleanOption((option) =>
        option
            .setName("silent")
            .setDescription(t("util:commands.migrate.options.silent.description"))
            .setNameLocalizations(LanguageLoader.getKeyLocalications("util:commands.migrate.options.silent.name"))
            .setDescriptionLocalizations(LanguageLoader.getKeyLocalications("util:commands.migrate.options.silent.description"))
            .setRequired(false)
    )
